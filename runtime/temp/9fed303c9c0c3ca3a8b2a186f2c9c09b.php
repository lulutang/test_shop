<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"/Applications/XAMPP/xamppfiles/htdocs/shop/public/../application/admin/view/upload/index.html";i:1482915819;s:94:"/Applications/XAMPP/xamppfiles/htdocs/shop/public/../application/admin/view/template/base.html";i:1482488954;s:105:"/Applications/XAMPP/xamppfiles/htdocs/shop/public/../application/admin/view/template/javascript_vars.html";i:1482488954;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    function callback(id,value) {
        if (window.parent.frames.length == 0){
            ...
            arr = id.split('_'); 
            if(arr[0] == 'img' && arr[1] == 'src'){
                parent.document.getElementById(id).src = value;

                parent.document.getElementById('upload_'+arr[2]).value = value;
